...
public class update_delete extends AppCompatActivity {
    ...
    Button tvButtonU;
    Button tvButtonD;
    update_delete.MyTask mt;

    update_delete.MyTaskU mtu;
    update_delete.MyTaskD mtd;
    ListView lvMain;
...
//******************************************************************************************
    ...
    class MyTask extends AsyncTask<String, Void, ArrayList<String[]>> {
        ...
        protected ArrayList<String[]> doInBackground(String... params) {
            ...
            String total = "";
            try {
                URL githubEndpoint = new URL("http://192.168.43.171:8080/kino/filtrtheatres?name=" + params[0]);
                myConnection =
        ...
        protected void onPostExecute(ArrayList<String[]> result) {
            ...
            update_delete.ClAdapter clAdapter = new update_delete.ClAdapter(tvInfo.getContext(), result);
            lvMain = (ListView) findViewById(R.id.lvMain);
...
//            int n=lvMain.getChildCount();
    ...
    class MyTaskU extends AsyncTask<JSONArray, Void, String> {
        ...
        protected String doInBackground(JSONArray... jsonArrays) {
            ...
            JSONObject obj = null;
            try {
                URL githubEndpoint = new URL("http://192.168.43.171:8080/kino/update_theatres/index.php");
                myConnection =
                        (HttpURLConnection) githubEndpoint.openConnection();
            } catch (MalformedURLException e) {
                e.printStackTrace();
...
//                tvInfo.setText(str);
    ...
    class MyTaskD extends AsyncTask<JSONArray, Void, String> {
        ...
        protected String doInBackground(JSONArray... jsonArrays) {
            ...
            JSONObject obj = null;
            try {
                URL githubEndpoint = new URL("http://192.168.43.171:8080/kino/delete_theatres/index.php");
                myConnection =
                        (HttpURLConnection) githubEndpoint.openConnection();
            } catch (MalformedURLException e) {
                e.printStackTrace();
